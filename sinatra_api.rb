...
namespace '/api/v1' do
  ...
  helpers do 
    ...
    # request
    def book
      @book ||= Book.where(id: params[:id]).first # give us the book we are looking for or the first one, but we should return 404 instead
    end
  ...
  get '/books' do 
    ...
    # Change this from books.to_json to:
